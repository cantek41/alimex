...
namespace Organization
{
 public class OrgContainerShape : RadDiagramContainerShape
    { 
        ...
        {
            return new OrgHeaderPresenterElement(_context,this.ToggleCollapseButton, this.Label) { MaxSize = new Size(250,0), MinSize = new Size(0,48), Alignment = ContentAlignment.TopCenter };
        }
